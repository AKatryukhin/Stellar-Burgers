...
export const requestIngredientsSuccess = (data: IAllIngredientsResponse): IRequestIngredientsSuccessAction => {
...
export const increaseCount = (ingredient: IIngredientData, count: number): IIncreaseCountAction => {
  return { type: INCREASE_COUNT, ingredient: ingredient, count: count }
}

export const decreaseCount = (ingredient: IIngredientData): IDecreaseCountAction => {
...
export const addCurrentIngredient = (ingredient: IIngredientData): IAddCurrentIngredientAction => {
